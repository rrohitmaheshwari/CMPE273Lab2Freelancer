   ...
   /* constructor(props) {
    ...
    handlePostProject = (event) => {
        ...
        if (name && desc && skills) {
            ...
            RESTService.postProject(project)
                        .then(
                            response => {
                ...
                <div className="jumbotron">
                    ...
                    <div className="pp-container">
                        <div className="pp-bg-container">
                            <div className="pp-bg">
                                <div className="pp-shape pp-big"></div>
                                <div className="pp-shape pp-medium"></div>
                                <div className="pp-shape pp-small"></div>
                            </div>
                        </div>

                        <div className="pp-header">
                            <div className="pp-header-logo">
                                <a href="/HomePage"><img className="header-logo-fullcolor" src={freeLogo} alt="Freelancer"></img></a>
                            </div>
                            <div>
                                <h1 className="header-title">Tell us what you need done</h1>
                                <p className="header-desc">
                                    Get free quotes from skilled freelancers within minutes, view profiles,
                            ...
                            <form onSubmit  = { this.handlePostProject }>
                                <ol className="pp-form">
                                    <li>
                                        <div className="form-field">
                                            <fieldset className="form-fieldset">
                                                <legend className="form-fieldset-legend">Choose a name for your project</legend>
                                                <ol className="pp-form">
                                    ...
                                    <li>
                                        <div className="form-field">
                                            <fieldset className="form-fieldset">
                                                <legend className="form-fieldset-legend">Tell us more about your project</legend>
                                                <p className="form-legend-subtext">
                                                    Great project descriptions include a little bit about yourself, details of what
                                                    you are trying to achieve, and any decisions that you have already made about your
                                                    project. If there are things you are unsure of, don't worry, a freelancer will be
                                                                ...
                                                                <table className="table-upload">
                                                                    <tbody className="table-upload-body">
                                                                    {
                                                                        projectFiles.map((data) =>
                                                                            <tr key = { projectFiles.indexOf(data) } className="table-upload-row">
                                    ...
                                    <li>
                                        <div className="form-field">
                                            <fieldset className="form-fieldset">
                                                <legend className="form-fieldset-legend">What skills are required?</legend>
                                                <p className="form-legend-subtext">
                                                    Enter up to 5 skills that best describe your project. Freelancers will
                                                    use these skills to find projects they are most interested and experienced in.
                                                </p>
                                                <ol className="pp-form">
                                                    <li className="form-step">
                                                        <input
                                    ...
                                    <li>
                                        <div className="form-field">
                                            <fieldset className="form-fieldset">
                                                <legend className="form-fieldset-legend">How do you want to pay?</legend>
                                                ...
                                                <ol className="budgetFields">
                                                    {
                                                        ...
                                                        <li className="form-step form-step--multiFields">
                                                            ...
                                                            <div className="form-step-fieldContainer bit-pad">
                                                                <select defaultValue    = "$250 - $750"
                                                                        name            = "projPay"
                                                                        ref             = "projectPay"
                                                                        className       = "large-input select-fields select-fields-fixed-proj">
                                                                    <option value="$10 - $30"
                                                                            label="Micro Project ($10 - 30 USD)">Micro Project
                                                                        ($10 - 30 USD)
                                                                    </option>
                                                                    <option value="$30 - $250"
                                                                            label="Simple project ($30 - 250 USD)">Simple
                                                                        project ($30 - 250 USD)
                                                                    </option>
                                                                    <option value="$250 - $750"
                                                                            label="Very small project ($250 - 750 USD)">Very
                                                                        small project ($250 - 750 USD)
                                                                    </option>
                                                                    <option value="$750 - $1500"
                                                                            label="Small project ($750 - 1500 USD)">Small
                                                                        project ($750 - 1500 USD)
                                                                    </option>
                                                                    <option value="$1500 - $3000"
                                                                            label="Medium project ($1500 - 3000 USD)">Medium
                                                                        project ($1500 - 3000 USD)
                                                                    </option>
                                                                    <option value="$3000 - $5000"
                                                                            label="Large project ($3000 - 5000 USD)">Large
                                                                        project ($3000 - 5000 USD)
                                                                    </option>
                                                                    <option value="$5000 - $10000"
                                                                            label="Larger project ($5000 - 10000 USD)">Larger
                                                                        project ($5000 - 10000 USD)
                                                                    </option>
                                                                    <option value="$10000 - $20000"
                                                                            label="Very Large project ($10000 - 20000 USD)">Very
                                                                        Large project ($10000 - 20000 USD)
                                                                    </option>
                                                                    <option value="$20000 - $50000"
                                                                            label="Huge project ($20000 - 50000 USD)">Huge
                                                                        project ($20000 - 50000 USD)
                                                                    </option>
                                                                    <option value="$50000 +  USD"
                                                                            label="Major project ($50000 +  USD)">Major project
                                                                        ($50000 + USD)
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <li className="form-step form-step--multiFields">
                                                            ...
                                                            <div className="form-step-fieldContainer bit-pad">
                                                                <select defaultValue    = "$15 - $25"
                                                                    ...
                                                                    <option value="$2 - $8"
                                                                            label="Basic ($2 - 8 USD)">Basic ($2 - 8 USD)
                                                                    </option>
                                                                    <option value="$8 - $15"
                                                                            label="Moderate ($8 - 15 USD)">Moderate ($8 - 15
                                                                        USD)
                                                                    </option>
                                                                    <option value="$15 - $25"
                                                                            label="Standard ($15 - 25 USD)">Standard ($15 -
                                                                        25 USD)
                                                                    </option>
                                                                    <option value="$25 - $50"
                                                                            label="Skilled ($25 - 50 USD)">Skilled ($25 - 50
                                                                        USD)
                                                                    </option>
                                                                    <option value="$50 +  USD"
                                                                            label="Expert ($50 +  USD)">Expert
                                                                        ($50 + USD)
                                                                    </option>
                                                                </select>
                                                            </div>
                                    ...
                                    <li>
                                        <fieldset className="form-fieldset">
                                            <legend className="form-fieldset-legend">What is your estimated project completion date?</legend>
                                            <div>
                                                <button
                                                    className = "btn-date"
                                    ...
                                    <li>
                                        ...
                                        <p className="pp-submit-terms">
                                            By clicking 'Post My Project', you agree to the Terms & Conditions and Privacy Policy
                                            <br/>
                        ...
                        <div className="pp-footer">
                            ...
                            <nav className="pp-footer-nav">
                                ...
                                <span className="pp-footer-text">Terms and Conditions</span>
                                <span className="pp-footer-text">Copyright Infringement Policy</span>
